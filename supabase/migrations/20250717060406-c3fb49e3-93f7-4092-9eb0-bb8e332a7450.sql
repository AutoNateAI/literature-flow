-- Add Literature Review AI prompts to the database
...
5. Recommend inclusion/exclusion criteria for my literature review', 'Setup and Planning', ARRAY['research-question', 'planning', 'scope'], 'Beginner', '15-20 minutes', '00000000-0000-0000-0000-000000000000'),
...
My field of study is [YOUR FIELD], and I''m particularly interested in [SPECIFIC INTERESTS].', 'Setup and Planning', ARRAY['search-strategy', 'databases', 'documentation'], 'Intermediate', '20-30 minutes', '00000000-0000-0000-0000-000000000000'),
...
Provide a template structure with example entries to help me get started.', 'Setup and Planning', ARRAY['organization', 'tracking', 'templates'], 'Beginner', '25-30 minutes', '00000000-0000-0000-0000-000000000000'),
...
Format this summary for easy reference later in my literature review.', 'Paper Analysis', ARRAY['summary', 'analysis', 'methodology'], 'Intermediate', '20-25 minutes', '00000000-0000-0000-0000-000000000000'),
...
8. Suggest how this theoretical approach relates to my interest in [YOUR FOCUS]', 'Paper Analysis', ARRAY['theory', 'framework', 'analysis'], 'Advanced', '25-30 minutes', '00000000-0000-0000-0000-000000000000'),
...
Format this as a structured evaluation I can use to compare methods across studies.', 'Paper Analysis', ARRAY['methodology', 'evaluation', 'research-design'], 'Advanced', '30-35 minutes', '00000000-0000-0000-0000-000000000000'),
...
Present this information in a structured, easily referenceable format.', 'Paper Analysis', ARRAY['results', 'findings', 'data-extraction'], 'Intermediate', '15-20 minutes', '00000000-0000-0000-0000-000000000000'),
...
Provide this evaluation in a balanced, academic tone I can reference in my review.', 'Paper Analysis', ARRAY['critical-evaluation', 'quality-assessment', 'analysis'], 'Advanced', '25-30 minutes', '00000000-0000-0000-0000-000000000000'),
...
Present the results as a thematic map I can use to structure my literature review.', 'Batch Processing', ARRAY['themes', 'multiple-papers', 'organization'], 'Intermediate', '30-40 minutes', '00000000-0000-0000-0000-000000000000'),
...
Format this as a narrative chronology with key milestones highlighted.', 'Batch Processing', ARRAY['chronological', 'evolution', 'trends'], 'Advanced', '35-45 minutes', '00000000-0000-0000-0000-000000000000'),
...
Format this as a comparative analysis I can reference when discussing methodology.', 'Batch Processing', ARRAY['methodology', 'comparison', 'analysis'], 'Advanced', '40-50 minutes', '00000000-0000-0000-0000-000000000000'),
...
Present this analysis in a structured format focusing on key contradictions.', 'Batch Processing', ARRAY['contradictions', 'analysis', 'reconciliation'], 'Advanced', '30-40 minutes', '00000000-0000-0000-0000-000000000000'),
...
Format this as a scholarly synthesis I can adapt for my literature review.', 'Synthesis', ARRAY['synthesis', 'integration', 'narrative'], 'Advanced', '45-60 minutes', '00000000-0000-0000-0000-000000000000'),
...
Describe this framework in detail and suggest how it could be visualized as a conceptual model or diagram.', 'Synthesis', ARRAY['framework', 'conceptual-model', 'theory'], 'Advanced', '50-70 minutes', '00000000-0000-0000-0000-000000000000'),
...
Present this as a structured gap analysis I can use to position my research.', 'Synthesis', ARRAY['gaps', 'opportunities', 'future-research'], 'Advanced', '40-55 minutes', '00000000-0000-0000-0000-000000000000'),
...
Format this as an interdisciplinary analysis that enriches my literature review.', 'Synthesis', ARRAY['interdisciplinary', 'cross-field', 'connections'], 'Advanced', '35-45 minutes', '00000000-0000-0000-0000-000000000000'),
...
Write this in a formal academic style suitable for [INTENDED AUDIENCE/PUBLICATION].', 'Output Generation', ARRAY['introduction', 'writing', 'academic'], 'Intermediate', '30-40 minutes', '00000000-0000-0000-0000-000000000000'),
...
Format this as a formal methods section appropriate for [INTENDED AUDIENCE/PUBLICATION].', 'Output Generation', ARRAY['methods', 'systematic', 'documentation'], 'Intermediate', '25-35 minutes', '00000000-0000-0000-0000-000000000000'),
...
Write this in a formal academic style suitable for [INTENDED AUDIENCE/PUBLICATION].', 'Output Generation', ARRAY['conclusion', 'synthesis', 'future-directions'], 'Intermediate', '25-35 minutes', '00000000-0000-0000-0000-000000000000'),
...
Write this in a formal, concise style suitable for academic publication.', 'Output Generation', ARRAY['abstract', 'summary', 'publication'], 'Intermediate', '20-25 minutes', '00000000-0000-0000-0000-000000000000'),
...
- A detailed description I can use to create it', 'Output Generation', ARRAY['visuals', 'diagrams', 'presentation'], 'Intermediate', '30-40 minutes', '00000000-0000-0000-0000-000000000000'),
...
Provide detailed feedback I can use to refine my literature review.', 'Refinement', ARRAY['quality-check', 'consistency', 'review'], 'Advanced', '35-45 minutes', '00000000-0000-0000-0000-000000000000'),
...
Provide specific recommendations with example language I might use.', 'Refinement', ARRAY['theory', 'depth', 'enhancement'], 'Advanced', '40-50 minutes', '00000000-0000-0000-0000-000000000000'),
...
Provide specific suggestions for strengthening the evidence base of my review.', 'Refinement', ARRAY['citations', 'evidence', 'sources'], 'Advanced', '30-40 minutes', '00000000-0000-0000-0000-000000000000');
